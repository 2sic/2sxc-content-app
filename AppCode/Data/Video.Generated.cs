...
{
  /// <summary>
  /// Auto-Generated base class for Default.Video in separate namespace and special name to avoid accidental use.
  /// </summary>
  public abstract class ZagVideo: Custom.Data.CustomItem
  {
    ...
    /// </summary>
    public IFile VideoLinkFile => _item.File("VideoLink");

    /// <summary>
    /// Get the folder object for VideoLink.
    /// </summary>
    public IFolder VideoLinkFolder => _item.Folder("VideoLink");
  }
}